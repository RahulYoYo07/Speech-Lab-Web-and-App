...
public class PrivateProfileDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView Name = findViewById(R.id.DisplayNameDetail);
        final TextView Username = findViewById(R.id.DisplayUsernameDetail);
        final TextView Program = findViewById(R.id.DisplayProgramDetail);
        final TextView Dept = findViewById(R.id.DisplayDeptDetail);
        final TextView Contact = findViewById(R.id.DisplayContactDetail);
        final TextView Email = findViewById(R.id.DisplayEmailDetail);
        final TextView About = findViewById(R.id.DisplayAboutDetail);
        final TextView Website = findViewById(R.id.DisplayWebsiteDetail);
        final TextView Github = findViewById(R.id.DisplayGithubDetail);
        final TextView LinkedIn = findViewById(R.id.DisplayLinkedInDetail);
        final TextView ProgramDecide = findViewById(R.id.DisplayProgram);
        final TextView Room = findViewById(R.id.DisplayRoomDetail);
        final TextView RoomDecide = findViewById(R.id.DisplayRoom);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if(user.exists()){
                                ...
                                if(user.getString("ProfilePic").length() > 0){
                                    CircleImageView img = findViewById(R.id.profile);
