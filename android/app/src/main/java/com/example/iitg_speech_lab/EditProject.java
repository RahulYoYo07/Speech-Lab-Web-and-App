                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(user.exists()){
                                EditText Title = findViewById(R.id.EditProjectTitleDetail);
                                EditText AboutProject = findViewById(R.id.EditProjectAboutProjectDetail);
                                EditText Mentor = findViewById(R.id.EditProjectMentorDetail);
                                EditText People = findViewById(R.id.EditProjectProjectPeopleDetail);
                                EditText Achievements = findViewById(R.id.EditProjectProjectAchievementsDetails);
