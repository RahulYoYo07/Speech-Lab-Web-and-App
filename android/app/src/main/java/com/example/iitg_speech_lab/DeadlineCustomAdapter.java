...
public class DeadlineCustomAdapter extends RecyclerView.Adapter<DeadlineCustomAdapter.MyViewHolder>  {
    ...
    DeadlineCustomAdapter(ArrayList<TADataModel> data) {
        this.dataSet = data;
    }

    @NonNull
    public DeadlineCustomAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                 int viewType) {
        ...
        return new DeadlineCustomAdapter.MyViewHolder(view);
    }

    public void onBindViewHolder(final DeadlineCustomAdapter.MyViewHolder holder, final int listPosition) {
