...
public class StudentCoursesCustomAdapter extends RecyclerView.Adapter<StudentCoursesCustomAdapter.MyViewHolder> {

    private ArrayList<StudentCoursesDataModel> dataSet;
    ...
    StudentCoursesCustomAdapter(ArrayList<StudentCoursesDataModel> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        view.setOnClickListener(StudentCoursesActivity.myOnClickListener);
