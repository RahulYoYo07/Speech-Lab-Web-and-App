...
public class Discussion_Room_Assignment_Groups extends AppCompatActivity {
...
//        final String message="CS243_2018";
        TextView heading= findViewById(R.id.DiscussionHeading_assignment);
        ...
        spinner = findViewById(R.id.progressBar11);

        spinner.setVisibility(View.VISIBLE);
        final ConstraintLayout lm = findViewById(R.id.discussion_layout_assignment);
        ...
        final LinearLayout ll = findViewById(R.id.lol_assignment);
...
//
        ...
        db3.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").orderBy("PostTime")
...
//                                        System.out.println(helptext);
                                        ...
                                        replybtn.setOnClickListener(new View.OnClickListener() {
                                            public void onClick(View v) {
                                                ...
                                                db.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").document(messageID).collection("Replies")
                                                        .add(data);
                                                et.setText("");
                                        ...
                                        btn.setOnClickListener(new View.OnClickListener() {
                                            public void onClick(View v) {
                                                if(btn.getText()=="Show Replies") {
                                                    ...
                                                    db2.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").document(messageID).collection("Replies").orderBy("PostTime").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                                        @Override
                                        ...
                                        db.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").document(messageID).collection("Replies").orderBy("PostTime")
...
//                                        System.out.println(helptext);
                                        ...
                                        FirebaseFirestore db2 = FirebaseFirestore.getInstance();
                                        DocumentReference docRef2 = db2.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").document(messageID2);
...
//                                                                System.out.println(rdbtn);
                                                    ...
                                                    db.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").document(messageID2).collection("Replies").addSnapshotListener(new EventListener<QuerySnapshot>() {
                                                        @Override
...
//        descriptionBox.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                db.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages")
                        .add(data);
            }
        });
...
// Add a TextView here for the "Title" label, as noted in the comments
        ...
        layout.addView(titleBox); // Notice this is an add method
        final Discussion_Room_Assignment_Groups help2=this;
...
//        List<String> vowelsList = Arrays.asList(pollop);
                ...
                db.collection("Courses").document(message).collection("Assignments").document(AssignmentId).collection("Groups").document(GroupId).collection("Messages").add(data);
            }
        });
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
