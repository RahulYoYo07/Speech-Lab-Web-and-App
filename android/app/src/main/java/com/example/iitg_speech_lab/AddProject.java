...
public class AddProject extends AppCompatActivity {
    ...
    public void AddProject(View view){
        EditText Title = findViewById(R.id.TitleDetail);
        EditText AboutProject = findViewById(R.id.AboutProjectDetail);
        EditText Mentor = findViewById(R.id.MentorDetail);
        EditText People = findViewById(R.id.ProjectPeopleDetail);
        EditText Achievements = findViewById(R.id.ProjectAchievementsDetails);
        String str;
