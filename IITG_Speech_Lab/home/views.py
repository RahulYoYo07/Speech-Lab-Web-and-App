...
#homepage code
def home (request):
    return HttpResponse('<h1>Home Page chal rha h</h1>')

#projects code
def projects(request):
    docs = db.collection(u'Projects').get()
    project_detail = []
    for doc in docs:
        # print (doc)
        project_detail.append(doc.to_dict())
    context = {
        'project_detail': project_detail,
    }
    return render(request, 'home/projects.html', context)
    #render(request, 'home/projects.html', proj_dic)
